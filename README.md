...
3. To use different combinations of models and linkers, the [config.yaml](https://github.com/hrshdhgd/oakx-spacy/blob/main/config.yaml#L35-L36) file can be edited.
# Acknowledgements
